...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 24.0, 219.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 111.0, 17.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 111.0, 184.0, 61.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 43.0, 293.0, 134.0 ],
					"text" : "(omchreode::make-flip\n   (omchreode::make-chreode 100 :decr :up 36 20)\n   (omchreode::make-chreode 99 :incr :down 32 20)\n   (omchreode::make-chreode 98 :decr :up 28 10)\n   (omchreode::make-chreode 97 :incr :down 24 10)\n   (omchreode::make-chreode 96 :decr :up 20 5)\n   (omchreode::make-chreode 95 :incr :down 16 5)\n)"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 330.0, 119.0, 57.0 ],
					"varname" : "bp258915374866",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 398.0, 214.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numpoints" : 1001,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 475.0, 214.0, 96.0 ],
					"subplots" : [ 						{
							...
							"domain_markers" : [  ],
							"domain_labels" : [  ],
							"range_start" : 11.0820875,
							"range_end" : 52.083370000000002,
							"range_style" : "linear",
							"range_markers" : [  ],
							"range_labels" : [  ],
							"origin_x" : 0.0,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 281.0, 93.0, 32.0 ],
					"varname" : "bp52844123262",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 195.0, 201.0, 70.0 ],
					"varname" : "arithm-ser",
					"viewvisibility" : 1
				}
