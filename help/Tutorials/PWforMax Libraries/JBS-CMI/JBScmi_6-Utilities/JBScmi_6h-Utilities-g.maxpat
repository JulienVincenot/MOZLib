...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 579.416606903076172, 510.0, 110.0, 20.0 ],
					"text" : "reconstruction"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.166606903076172, 94.0, 214.0, 71.0 ],
					"text" : "It allows you to reconstitute \nnew sequences based on the original's identity indexes, \nby specifying a different list \nof associated indexes."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.666606903076172, 425.0, 406.0, 32.0 ],
					"text" : "Attention: \nIdentity numbers or indexes start from 1 and not from zero !"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.666606903076172, 54.0, 267.0, 32.0 ],
					"text" : "The function RECONSTITUTE-FROM-INDEXES works in tandem with IDENTITY-INDEX. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.666606903076172, 31.6875, 373.0, 96.0 ],
					"text" : "IDENTITY-INDEX attributes a number for each different element of a given list. This function is derived \nfrom the theory of contrastive analysis by Frédéric Voisin and Hervé Rivière (see also FV-Morphologie). This function is useful whenever you want to transform any atom, symbol, list or list of lists into an attributed number."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 534.0, 170.0, 22.0 ],
					"text" : "A B A A A [ A B C ] D [ A B C ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 471.0, 103.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 234.0, 101.0, 22.0 ],
					"text" : "lisp.expr second l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 94.5, 140.0, 22.0 ],
					"text" : "a b a a a (a b c) d (a b c)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 122.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.666606903076172, 151.0, 170.0, 35.0 ],
					"text" : "lisp.expr jbs-cmi::identity-index list-elmt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.499940236409486, 510.0, 211.0, 20.0 ],
					"text" : "full-list-with-assoc-indexes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.666606903076172, 501.0, 74.0, 34.0 ],
					"text" : "identity-\nindexes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.333273569742843, 510.0, 139.0, 20.0 ],
					"text" : "associated-indexes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.499940236409486, 534.0, 247.0, 35.0 ],
					"text" : "[ A 1 ] [ B 2 ] [ A 1 ] [ A 1 ] [ A 1 ] [ [ A B C ] 3 ] [ D 4 ] [ [ A B C ] 3 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.333273569742843, 534.0, 179.0, 22.0 ],
					"text" : "[ A 1 ] [ B 2 ] [ [ A B C ] 3 ] [ D 4 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 12.666606903076172, 471.0, 487.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.666606903076172, 27.0, 140.0, 22.0 ],
					"text" : "a b a a a (a b c) d (a b c)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.666606903076172, 54.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.666606903076172, 81.0, 127.0, 49.0 ],
					"text" : "lisp.expr jbs-cmi::identity-index list-elmt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.666606903076172, 444.0, 64.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.166606903076172, 534.0, 95.0, 22.0 ],
					"text" : "1 2 1 1 1 3 4 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.666606903076172, 418.0, 80.0, 22.0 ],
					"text" : "lisp.quickeval"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 22.166606903076172, 496.0, 97.666606903076172, 496.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 256.166606903076172, 499.0, 280.833273569742857, 499.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 490.166606903076172, 501.0, 531.999940236409429, 501.0 ],
					"source" : [ "obj-25", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 555.166606903076172, 500.5, 706.166606903076172, 500.5 ],
					"source" : [ "obj-55", 0 ]
				}
