...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 607.0, 233.0, 146.0, 20.0 ],
					"text" : "<= Now click here !"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 684.0, 248.0, 341.0, 62.0 ],
					"text" : "On this side we use lisp.iterate \nto show successive results \nby this function for a given value, \nup to the 30th level of recursion."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 3.0 ],
					"patching_rect" : [ 368.0, 306.141021728515625, 24.0, 25.71795654296875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 3.0 ],
					"patching_rect" : [ 546.25, 308.0, 24.0, 25.71795654296875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 69.0, 319.0, 76.0 ],
					"text" : "Instead of the start, step and end\nparameters of the classic pw::arithm-ser, \nthis variant replaces the ending value \nby a 'how-many?' argument which determines \nthe length of the result."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.5, 325.5, 110.0, 20.0 ],
					"text" : "compare with :"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 273.0, 74.0, 20.0 ],
					"text" : "how-many?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 246.0, 37.0, 20.0 ],
					"text" : "step"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 208.0, 45.0, 20.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.25, 325.5, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.5, 439.5, 89.0, 22.0 ],
					"text" : "moz.ezbpf2slot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 119.0, 648.0, 104.0 ],
					"text" : "As its name suggests, GOLD-SECTION-MULTIPLICATION multiplies\na given number [1] by the gold section ratio (0.618).\n\nThe function can be recalled recursively. In [2] you define \nhow many levels of recursion you want. With 1 you call the function once; \nwith 2 you apply the multiplication on the first result; with 3 you apply \nit again on the second result, and so on..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "x" ],
					"patching_rect" : [ 663.0, 312.274971963428925, 45.0, 22.0 ],
					"text" : "t 312 x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.0, 233.0, 29.5, 22.0 ],
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 572.0, 367.274971963428925, 63.0, 22.0 ],
					"text" : "lisp.iterate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 424.774971963428925, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.0, 270.0, 109.0, 22.0 ],
					"text" : "lisp.for-fromto 1 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 367.274971963428925, 195.0, 49.0 ],
					"text" : "lisp.expr jbs-cmi::gold-section-multiplication number gr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 443.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 477.0, 163.0, 22.0 ],
					"text" : "192.816"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 407.5, 80.0, 22.0 ],
					"text" : "lisp.quickeval"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 316.0, 233.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 308.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 316.0, 308.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 270.0, 83.0, 22.0 ],
					"text" : "loadmess 312"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 270.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 346.0, 195.0, 49.0 ],
					"text" : "lisp.expr jbs-cmi::gold-section-multiplication number gr"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.25, 249.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.5, 223.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 185.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 147.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.25, 211.0, 70.0, 22.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.5, 185.0, 77.0, 22.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 287.0, 188.0, 35.0 ],
					"text" : "lisp.expr jbs-cmi::arithm-ser-stop list indexes elements @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 392.0, 103.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 425.0, 112.0, 22.0 ],
					"text" : "1 11 21 31 41"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.666606903076172, 32.0, 339.0, 34.0 ],
					"text" : "ARITHMETIC-SER-STOP generates an arithmetic series with specific stopping condition."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 358.0, 80.0, 22.0 ],
					"text" : "lisp.quickeval"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 581.5, 400.887485981714462, 325.5, 400.887485981714462 ],
					"source" : [ "obj-110", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 18.5, 421.5, 111.5, 421.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 325.5, 471.0, 479.0, 471.0, 479.0, 433.0, 504.0, 433.0 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 325.5, 472.0, 469.5, 472.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 142.75, 352.25, 18.5, 352.25 ],
					"source" : [ "obj-9", 0 ]
				}
