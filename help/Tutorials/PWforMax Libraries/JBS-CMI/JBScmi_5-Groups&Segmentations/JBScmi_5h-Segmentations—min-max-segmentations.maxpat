...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.833393096923828, 487.0, 442.0, 20.0 ],
					"text" : "You may use this BPF profile when comparing the two results."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.833393096923828, 353.0, 271.0, 34.0 ],
					"text" : "Note these functions will work only with numbers, not with symbols !"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 428.833393096923828, 198.0, 500.0, 34.0 ],
					"text" : "Both functions will generate a group of sublists, with segmentation \npoints located before and after a point of minimum (or maximum)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.833393096923828, 164.0, 384.0, 48.0 ],
					"text" : "These two functions create a segmentation of a list \nbased on primitive forms, i.e. minima and maxima \n(see the Morphologie library to learn more)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.333393096923828, 346.0, 100.0, 22.0 ],
					"text" : "moz.ezbpf2slot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 106.333393096923828, 214.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 309.0, 244.0, 22.0 ],
					"text" : "lisp.expr jbs-cmi::minimum-segmentation list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 243.0, 125.0, 22.0 ],
					"text" : "1 2 3 2 3 4 1 2 3 4 5 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 279.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.333393096923828, 309.0, 247.0, 22.0 ],
					"text" : "lisp.expr jbs-cmi::maximum-segmentation list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.333393096923828, 243.0, 125.0, 22.0 ],
					"text" : "1 2 3 2 3 4 1 2 3 4 5 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.333393096923828, 279.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 391.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 429.0, 314.0, 22.0 ],
					"text" : "[ 1 2 ] [ 3 2 3 ] [ 4 1 2 3 4 ] [ 5 4 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.333393096923828, 359.0, 80.0, 22.0 ],
					"text" : "lisp.quickeval"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 449.833393096923828, 420.5, 744.833393096923828, 420.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 182.833393096923828, 338.5, 449.833393096923828, 338.5 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 115.833393096923828, 346.0, 115.833393096923828, 346.0 ],
					"order" : 1,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 115.833393096923828, 271.5, 182.833393096923828, 271.5 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
