...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.400000751018524, 64.400007784366721, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 953.358156028368739, 48.256410256410248, 114.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 896.0, 17.256410256410248, 125.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 896.0, 48.256410256410248, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.200002253055573, 77.0, 423.0, 60.0 ],
					"text" : "The module has settings for different test functions, \nto consider or ignore grace notes, and to break at rests.\n\nJust experiment with it to see how the results behave !"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.166663885116577, 152.0, 264.0, 21.0 ],
					"text" : "durations 1/8, then_interval :smaller-than, intervals 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 38.166663885116577, 127.0, 54.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 181.0, 306.0, 177.0 ],
					"varname" : "bp443152287102",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 181.0, 306.0, 177.0 ],
					"varname" : "bp522018996467",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.200002253055573, 64.400007784366721, 64.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.200002253055573, 40.0, 121.0, 21.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80102
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 64.400007784366721, 50.0, 21.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.400000751018524, 64.400007784366721, 64.0, 21.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80102
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.0, 258.0, 82.0, 22.0 ],
					"text" : "loadmess 113"
				}
...
,
					"patching_rect" : [ 394.0, 286.0, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.125, 311.099514563106709, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.125, 337.099514563106709, 59.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.400000751018524, 40.0, 42.0, 21.0 ],
					"text" : "1/4 1/8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 457.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 352.0, 368.0, 205.0, 78.0 ],
					"varname" : "bp437308231285",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 92.0, 233.0, 30.0 ],
					"varname" : "bp718502702155",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 403.625, 365.099514563106709, 361.5, 365.099514563106709 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 125.900000751018524, 36.0, 232.700002253055573, 36.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 125.900000751018524, 36.700003892183361, 44.5, 36.700003892183361 ],
					"order" : 2,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 18.5, 370.0, 338.0, 370.0, 338.0, 163.0, 361.5, 163.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 18.5, 157.0, 18.5, 157.0 ],
					"source" : [ "obj-96", 0 ]
				}
