...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 207.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.0, 105.5, 54.0, 22.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.0, 126.0, 64.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.0, 101.0, 121.0, 21.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80300
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 100.0, 187.0, 21.0 ],
									"text" : "(1/8)"
								}
...
,
					"patching_rect" : [ 9.0, 48.0, 233.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 343.0, 545.0, 45.0 ],
					"text" : "Note : This approach can be used in similar situations, where different versions\nof the same rule can coexist, as long as they don't create logical contradictions\n(for instance, rules based on indexes, positions or time intervals).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 292.0, 465.0, 32.0 ],
					"text" : "In this example, we determine a different pitch range for each index in the solution, to generate a solution that is globally ascending.",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1269.0, 101.0, 114.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 404.0, 267.0, 19.0 ],
					"text" : "                       'CLUSTERcollect'",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 355.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 404.0, 565.0, 58.0 ],
					"text" : "In the end, we use the 'CLUSTERcollect' module to receive a flat list containing\nthe rule part of all the different rule variants (open the bach.reg to see more),\nand re-introduce those in the chain of CLUSTER modules. If you open the 'rule_loop'\nabstraction, you'll see there is a little trick you need to use to make this work...",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 100.0, 446.0, 32.0 ],
					"text" : "In certain situations, you might want to use a same Cluster rule\nin different positions of a result, but with different parameters.",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 9.0, 289.0, 244.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 355.0, 68.0, 21.0 ],
					"text" : "variables $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 83.0, 233.0, 174.0 ],
					"varname" : "bp157897410388",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 622.0, 230.0, 131.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80300
									}
,
...
,
					"patching_rect" : [ 280.0, 297.0, 71.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 256.0, 336.0, 22.0 ],
					"text" : "(55 61) (60 63) (62 65) (64 68) (68 72) (72 78) (75 83) (77 92)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1209.0, 70.0, 125.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1209.0, 101.0, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 173.0, 591.0, 45.0 ],
					"text" : "This can be achieve in a procedural way, using a loop construct (with bach.iter/collect)\nto generate as many versions of the same rule. This allows to control your constraint\ngenerations in a more 'granular' way so to speak.",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 341.5, 338.5, 37.5, 338.5 ],
					"source" : [ "obj-32", 1 ]
				}
