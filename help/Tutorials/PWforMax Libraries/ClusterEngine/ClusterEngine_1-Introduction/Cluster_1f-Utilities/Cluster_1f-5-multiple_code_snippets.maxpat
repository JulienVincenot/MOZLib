...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.833333333333371, 168.099514563106709, 124.0, 34.0 ],
					"text" : "some personal \nLisp code inside"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.833333333333371, 547.199029126213418, 174.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.333333333333371, 417.0, 527.0, 58.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 10.0, 616.0, 186.0 ],
					"text" : "Here is an example showing how to use at the same time some personal Lisp code in parallel with the CLUSTERpreferences and CLUSTER debug modules, thanks to lisp.code_accum.\n\nCLUSTERpreferences drives the whole group of code snippets, since its content might change more than others here. Toggle backjump? on and off and see how the code changes in the end.\n\nEach modification of its settings triggers the following chain of events :\n- lisp.code_accum is cleared (null)\n- custom code is sent from bach.reg\n- CLUSTERdebug is refreshed to ensure the connection with chainedPMC\n- CLUSTERpreferences parameters are finally sent \n\nYou can of course imagine similar scenarios if you generate custom code\nfrom several abstractions for instance..."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 111.0, 280.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.333333333333371, 521.199029126213418, 167.0, 22.0 ],
					"text" : "code_snippet bach.llll 69123"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.333333333333371, 489.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 87.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 96.0, 417.0, 111.0, 22.0 ],
					"text" : "route code_snippet"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 10.0, 288.0, 74.0 ],
					"varname" : "bp419948672574",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 96.0, 209.0, 766.0, 200.0 ],
					"varname" : "bp1581876836731",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.666666666666629, 143.099514563106709, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.833333333333371, 521.199029126213418, 666.0, 49.0 ],
					"text" : "[ defun monplus [ x y z ] [ + x y z ] ] [ defun monminus [ x y z ] [ - x y z ] ] [ print [ monplus 0 1 2 ] ] [ print [ monminus 0 1 2 ] ] [ ce::preferences t 10000000 :self :other :other :rhythm :rhythm :self :rhythm :self :next-pitch :next ] [ setf *debug-filename* [ quote \\\"/tmp/399373_CLUSTER-DEBUG.LISP\\\" ] ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 191.833333333333371, 489.199029126213418, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80102
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.333333333333371, 454.099514563106709, 98.0, 22.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 105.5, 446.049757281553354, 18.833333333333371, 446.049757281553354 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 143.166666666666629, 171.099514563106709, 18.833333333333371, 171.099514563106709 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 18.833333333333371, 516.099514563106709, 166.833333333333371, 516.099514563106709 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 18.833333333333371, 489.549757281553411, 18.833333333333371, 489.549757281553411 ],
					"order" : 1,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 18.833333333333371, 481.649271844660007, 201.333333333333371, 481.649271844660007 ],
					"order" : 0,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.333333333333371, 515.699029126213418, 848.333333333333371, 515.699029126213418 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 192.5, 139.549757281553354, 143.166666666666629, 139.549757281553354 ],
					"source" : [ "obj-5", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 279.5, 203.049757281553354, 18.833333333333371, 203.049757281553354 ],
					"source" : [ "obj-5", 3 ]
				}
