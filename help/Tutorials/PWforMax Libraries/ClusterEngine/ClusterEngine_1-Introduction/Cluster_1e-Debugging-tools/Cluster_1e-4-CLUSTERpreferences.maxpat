...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 563.0, 164.0, 135.0, 19.0 ],
					"text" : "max. number of loops"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 538.0, 127.0, 59.0, 19.0 ],
					"text" : "Backjump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 50.078125, 527.0, 68.0 ],
					"text" : "The module needs to be connected to the chainedCLUSTER module to have an effect \n— i.e. it will send the appropriate code_snippet message. \n\nIf you just connected it, you might need to bypass on and off or change some \nparameter at least once, otherwise the module won't send any code_snippet message."
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 17.032028433212695,
					"id" : "obj-17",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.375, 77.0, 96.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 120.400000751018524, 77.0, 33.0, 22.0 ],
									"text" : "(1/4)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 120.400000751018524, 40.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 107.0, 233.0, 30.0 ],
									"varname" : "bp1235094835698",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.0, 77.0, 179.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 154.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 129.900000751018524, 69.0, 129.900000751018524, 69.0 ],
									"order" : 1,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 129.900000751018524, 69.0, 236.5, 69.0 ],
									"order" : 0,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 129.900000751018524, 69.0, 33.875, 69.0 ],
									"order" : 2,
									"source" : [ "obj-23", 0 ]
								}
...
,
					"patching_rect" : [ 9.0, 68.078125, 91.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1119.358156028368739, 41.0, 114.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1062.0, 10.0, 125.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1062.0, 41.0, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 10.0, 495.0, 31.0 ],
					"text" : "The CLUSTERpreferences module sets how the engine behaves during the search. \nIn most cases there should be no reason to change these settings."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 147.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 175.0, 288.0, 292.0 ],
					"varname" : "bp777797502475",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 195.0, 308.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 49.0, 288.0, 74.0 ],
					"varname" : "bp1623921979460",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 223.900485436893291, 83.0, 22.0 ],
					"text" : "loadmess 120"
				}
...
,
					"patching_rect" : [ 27.0, 251.900485436893291, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.0, 280.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 308.0, 59.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 419.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 338.0, 205.0, 78.0 ],
					"varname" : "bp721319377634",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 121.5, 199.049757281553354, 18.5, 199.049757281553354 ],
					"source" : [ "obj-8", 0 ]
				}
