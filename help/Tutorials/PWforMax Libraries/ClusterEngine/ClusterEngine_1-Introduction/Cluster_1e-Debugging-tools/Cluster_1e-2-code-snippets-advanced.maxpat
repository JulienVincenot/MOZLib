...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.0, 214.0, 485.0, 45.0 ],
					"text" : "Of course you can also create your own global variables. Here we sample \na bach.slot to generate a list of numbers between 0 and 11, which we'll use to represent pitch classes (modulo 12).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 943.358156028368739, 49.256410256410248, 114.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 203.0, 174.0, 19.0 ],
					"text" : "<= try raising that value",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 96.25, 619.5, 32.0 ],
					"text" : "Try evaluating the patch with v key, you should get an error... Now try to raise the number box's value from 20 to a higher value (25 or 30), and it should be working again. Why?!",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 53.0, 172.0, 233.0, 30.0 ],
									"varname" : "bp530076851265",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 267.0, 136.5, 69.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 267.0, 86.5, 49.0, 22.0 ],
									"text" : "48 72 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 267.0, 112.5, 88.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80102
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.375, 132.5, 63.0, 22.0 ],
									"text" : "collapse 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.400000751018524, 132.5, 40.0, 22.0 ],
									"text" : "(1/16)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 194.400000751018524, 22.5, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 53.0, 22.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 53.0, 218.5, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 203.900000751018524, 117.0, 169.900000751018524, 117.0 ],
									"order" : 1,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 203.900000751018524, 117.0, 103.875, 117.0 ],
									"order" : 2,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 203.900000751018524, 72.0, 276.5, 72.0 ],
									"order" : 0,
									"source" : [ "obj-23", 0 ]
								}
...
,
					"patching_rect" : [ 9.0, 37.234375, 97.0, 29.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 878.0, 18.256410256410248, 122.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 878.0, 49.256410256410248, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 106.900000751018524, 371.099514563106709, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.900000751018524, 381.099514563106709, 73.0, 22.0 ],
					"text" : "variables $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.900000751018524, 356.952573750254089, 60.0, 19.0 ],
					"text" : "loadmess 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.5, 267.599514563106709, 293.0, 45.0 ],
					"text" : "Sending the null message with code_snippet \nprefix will disable any code that was sent \nto it previously.",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 213.0, 147.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 250.0, 256.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 375.0, 179.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.0, 55.0, 255.0, 22.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 87.0, 94.0, 22.0 ],
									"text" : "*modulo-profile*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 137.0, 142.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 87.0, 63.0, 22.0 ],
									"text" : "all-pitches"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 283.0, 127.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 314.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 323.5, 151.0, 109.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 195.0, 336.099514563106709, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 151.732991333333302, 65.0, 22.0 ],
									"text" : "bach.% 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 118.549743499999977, 69.0, 22.0 ],
									"text" : "bach.round"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 85.366495666666651, 65.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80102
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 184.916239166666628, 57.0, 22.0 ],
									"text" : "pw.quote"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 13.0, 52.183247833333326, 105.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80102
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 218.099486999999954, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 498.086633663366342, 379.566343042071026, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.586633663366342, 406.665857605177848, 238.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 569.923267326732685, 379.566343042071026, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.25, 268.566343042071026, 74.0, 22.0 ],
					"text" : "sample 1 12"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nn",
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 426.25, 293.599514563106652, 162.673267326732685, 81.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.900000751018524, 108.25, 307.0, 20.0 ],
					"text" : "rule_parameter pitches, rule_input :all-pitches, bypass 1, collapse 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 22.900000751018524, 84.75, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 9.0, 148.0, 294.0, 27.0 ],
					"varname" : "bp220491750505",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.5, 266.566343042071026, 307.0, 135.0 ],
					"text" : "When you click the sample message or just modify the content of the slot, the profile will be output and eventually stored as \na Lisp global variable via code_snippet, using the Lisp function DEFPARAMETER.\n\nNow the *modulo-profile* variable happens to be used in the bypassed 'r-one-engine' rule that we didn't mention yet... \nlet's give it a try!",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.5, 132.5, 505.0, 58.0 ],
					"text" : "What we did here was simply access a global variable of the Cluster-Engine \nin Lisp, *max-number-of-loops*, which is explained later in this section \n(cf. CLUSTERpreferences). For now you just need to know that this variable \ncannot be accessed without using a code_snippet.",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.5, 9.0, 761.5, 83.0 ],
					"text" : "As you may have seen in its dedicated section already, the chainedCLUSTER module can accept messages \nwith the 'code_snippet' prefix, which allow to introduce some extra piece of Lisp code prior to evaluation.\n\nSometimes you might want to work with global variables in the Lisp code that are not accessible in the interface we built, or simply to add functions temporarily that are not available in the environment. \nAs you may guess, this will be quite handy for debugging...",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 432.099505026363545, 602.5, 45.0 ],
					"text" : "Note : Each new code_snippet message destroys the previous one, which can be problematic if you want to use personal code at the same time as CLUSTERdebug or CLUSTERpreferences for instance. Cf. 'Utilities' section for a way to fix this issue..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 179.0, 65.0, 20.0 ],
					"text" : "loadmess 20"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 202.0, 107.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 228.0, 322.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.5, 281.599514563106709, 29.5, 22.0 ],
					"text" : "null"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 320.566343042071026, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.875, 342.0, 83.0, 22.0 ],
					"text" : "loadmess 120"
				}
...
,
					"patching_rect" : [ 26.875, 355.0, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.875, 371.099514563106709, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.875, 381.099514563106709, 59.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 451.099505026363545, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 368.0, 205.0, 78.0 ],
					"varname" : "bp684960319518",
					"viewvisibility" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 351.549757281553354, 18.5, 351.549757281553354 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 41.5, 315.299757281553354, 41.5, 315.299757281553354 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 201.549757281553354, 41.5, 201.549757281553354 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 579.423267326732685, 421.566343042071026, 639.75, 421.566343042071026, 639.75, 263.566343042071026, 435.75, 263.566343042071026 ],
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 288.086633663366342, 451.0, 254.0, 451.0, 254.0, 316.0, 41.5, 316.0 ],
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
		...
		"autosave" : 0,
		"boxgroups" : [ 			{
				"boxes" : [ "obj-69", "obj-58", "obj-77", "obj-71", "obj-62" ]
			}
 ]
	}
