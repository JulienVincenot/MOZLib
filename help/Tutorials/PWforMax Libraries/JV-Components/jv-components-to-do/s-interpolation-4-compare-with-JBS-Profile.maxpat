...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"fontsize" : 17.815527394329493,
					"id" : "obj-3",
					"linecount" : 3,
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.0, 5.375628140703519, 587.0, 66.0 ],
					"text" : "version of JBS profile interpolation (with resampling) converted for chords\n\n-> compare the results with s-interpolations"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 25.0, 27.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.428571428571445, 95.0, 289.0, 22.0 ],
					"text" : "collapse 2, [ 3700 5000 6200 6800 7600 7900 8500 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.25, 69.0, 169.0, 22.0 ],
					"text" : "collapse 2, [ 4900 6200 7400 ]"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 16.0, 505.0, 766.0, 202.0 ],
					"varname" : "bp881094628425",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 620.0, 97.0, 172.0, 148.0 ],
					"varname" : "bp190313323983",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 20.0, 469.0, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.857142857142833, 339.0, 29.5, 22.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 844.5, 374.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 844.5, 346.0, 89.0, 22.0 ],
					"text" : "loadmess set 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 726.714285714285666, 374.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.714285714285666, 346.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 639.285714285714334, 374.0, 29.5, 22.0 ],
					"text" : "nil"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.785714285714334, 374.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.785714285714334, 332.0, 133.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.785714285714334, 306.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.785714285714278, 346.0, 65.0, 22.0 ],
					"text" : "bach./ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 346.0, 65.0, 22.0 ],
					"text" : "bach./ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.357142857142833, 273.0, 84.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.857142857142833, 313.0, 51.0, 22.0 ],
					"text" : "5 4 3 11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.428571428571445, 374.0, 29.5, 22.0 ],
					"text" : "nil"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.357142857142833, 374.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.785714285714278, 374.0, 60.0, 22.0 ],
					"text" : "lisp.quote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 374.0, 60.0, 22.0 ],
					"text" : "lisp.quote"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 182.0, 133.0, 151.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 126.0, 151.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.85714285714289, 374.0, 29.5, 22.0 ],
					"text" : "nil"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 454.428571428571445, 339.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.428571428571445, 374.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80105
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.428571428571445, 336.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 557.428571428571445, 268.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
,
					"patching_rect" : [ 490.428571428571445, 268.0, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.428571428571445, 95.0, 83.0, 22.0 ],
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.428571428571445, 119.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.428571428571445, 146.0, 81.0, 23.0 ],
					"text" : "sample 1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nn",
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 423.428571428571445, 174.21875, 153.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 255.571428571428555, 374.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.571428571428555, 346.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 406.0, 843.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 437.0, 80.0, 22.0 ],
					"text" : "lisp.quickeval"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 566.928571428571445, 298.21875, 591.0, 298.21875, 591.0, 90.21875, 432.928571428571445, 90.21875 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 4 ],
					"midpoints" : [ 463.928571428571445, 400.5, 500.642857142857167, 400.5 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 4 ],
					"midpoints" : [ 525.35714285714289, 400.5, 500.642857142857167, 400.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../Users/julienvincenot/Documents/Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
			}
, 			{
