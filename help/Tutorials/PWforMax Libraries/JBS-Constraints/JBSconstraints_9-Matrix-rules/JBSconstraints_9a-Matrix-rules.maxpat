...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.791606903076172, 208.0, 82.0, 22.0 ],
					"text" : "loadmess 118"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.666606903076172, 98.5, 479.0, 58.0 ],
					"text" : "This menu contains only three rules dealing with matrices. \nA matrix is a list of lists. A matrix is also a rectangular arrangement of numbers, where the horizontal and vertical lines are respectively called rows and columns."
				}
