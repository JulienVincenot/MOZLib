...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.125, 363.0, 77.0, 22.0 ],
									"text" : "loadmess 62"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.666606903076172, 140.0, 471.0, 71.0 ],
					"text" : "If you use the COUNT-POSITIVE-INTERVALS-RULE [1], the solution will have a number of positive intervals as indicated in 'number' [a].\n\nIf you use the COUNT-NEGATIVE-INTERVALS-RULE [2], the solution will have a number of negative intervals as indicated in 'number' [a]."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Count-positive/negative-intervals rules"
				}
