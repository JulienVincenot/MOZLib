...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 579.5, 112.73728813559319, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 579.5, 354.474576271186379, 65.0, 22.0 ],
					"text" : "bach./ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 579.5, 112.73728813559319, 295.0, 22.0 ],
					"text" : "6000 6100 6200 6300, collapse 2, to_chord zoom 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 579.5, 84.474576271186379, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 579.0, 144.0, 151.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.666606903076172, 407.0, 70.0, 22.0 ],
					"text" : "lisp.quote 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.666606903076172, 438.73728813559319, 258.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.666606903076172, 465.73728813559319, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 382.73728813559319, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 111.0, 354.474576271186379, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.4375, 433.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 457.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 417.0, 60.0, 22.0 ],
					"text" : "loadmess"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.375, 72.0, 29.5, 22.0 ],
									"text" : ":="
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 47.625, 72.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.75, 43.0, 77.0, 22.0 ],
									"text" : "loadmess 44"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 16.0, 103.0, 356.0, 203.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 360.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 23.0, 208.237288135593218, 123.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.4375, 71.73728813559319, 393.0, 250.0 ],
					"text" : "REPEAT-RESULTING-INTERVAL-RULE [1] obliges a solution to have a given resulting-interval repeated many times as indicated in the 'time' input. A resulting interval is an interval between a note and any possible other notes. \n\nIn this sense, look at the function FIND-ALL-INTERVALS (that you can call using the package JBS-CONSTRAINTS::FIND-ALL-INTERVALS). This function [a] gives all the intervals between all notes of a sequence.\n\nIf the menu which? is set on <, it means that the given interval has to be repeated a number of time inferior to the one put in times. \nIf the menu which? is set on =, it means that the given interval has to be repeated a number of time equal to the one put in times.\nIf the menu which? is set on >, it means that the given interval has to be repeated a number of times bigger than the one put in times."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 578.0, 43.0 ],
					"text" : "Repeat-resulting-interval rule"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 471.166606903076172, 491.368644067796595, 710.166606903076172, 491.368644067796595 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 372.5, 471.166606903076172, 372.5 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 589.0, 391.23728813559319, 471.166606903076172, 391.23728813559319 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"name" : "jbs_block_umenu_which3.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/MOZLib/patchers/pw4m_pmc",
				"patcherrelativepath" : "../../../../../patchers/pw4m_pmc",
				"type" : "JSON",
				"implicit" : 1
