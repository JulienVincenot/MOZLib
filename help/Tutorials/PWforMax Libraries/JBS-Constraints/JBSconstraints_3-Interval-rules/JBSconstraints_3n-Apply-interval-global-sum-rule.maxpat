...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 578.0, 428.0, 211.0, 42.0 ],
					"text" : "BUG fixed ! :)",
...
,
					"patching_rect" : [ 578.0, 295.0, 141.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"text" : "p get-interval-global-sum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 254.73728813559319, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 605.0, 226.474576271186379, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.666606903076172, 58.73728813559319, 287.0, 96.0 ],
					"text" : "This rule [1] outputs a solution having the sum of all intervals equal to the value put in 'sum'.\n\nThe difference from the APPLY-INTERVAL-SUM-RULE is to discover by yourself. [2]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Apply-interval-global-sum rule"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 587.5, 323.0, 667.5, 323.0 ],
					"source" : [ "obj-29", 0 ]
				}
