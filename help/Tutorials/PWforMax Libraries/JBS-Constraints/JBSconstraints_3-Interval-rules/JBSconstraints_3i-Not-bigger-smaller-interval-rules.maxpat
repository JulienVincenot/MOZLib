...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.4375, 319.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.0, 343.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 343.0, 102.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.375, 386.0, 29.5, 22.0 ],
									"text" : "4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.375, 386.0, 57.0, 22.0 ],
									"text" : ":absolute"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 47.625, 380.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.625, 350.0, 77.0, 22.0 ],
									"text" : "loadmess 50"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.375, 92.0, 29.5, 22.0 ],
									"text" : "4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.375, 92.0, 57.0, 22.0 ],
									"text" : ":absolute"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 47.625, 86.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.625, 56.0, 77.0, 22.0 ],
									"text" : "loadmess 48"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 642.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.666606903076172, 73.0, 471.0, 224.0 ],
					"text" : "This patch shows you two functions with a particular behaviour. \n\nTo use NOT-BIGGER-INTERVAL-RULE [1], you first need to define if you work on positive, negative or absolute intervals using the menu 'sign?' [a]. \n\nIf you choose '+', it means that this function does not allow intervals bigger than the one entered in 'limit' only for positive intervals. \nIf you choose '-', it means that this function does not allow intervals bigger than the one entered in 'limit' only for negative intervals. \nIf you choose 'absolute', it means that this function does not allow intervals bigger than the one entered in 'limit' both for positive and negative intervals.\n\nNOT-SMALLER-INTERVAL-RULE [2] does the opposite."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Not-bigger/smaller-interval rules"
				}
