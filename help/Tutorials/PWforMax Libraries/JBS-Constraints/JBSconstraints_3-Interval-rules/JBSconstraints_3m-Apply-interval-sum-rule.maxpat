...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 575.4375, 349.0, 99.0, 22.0 ],
					"text" : "bach.sum @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.4375, 322.0, 57.0, 22.0 ],
					"text" : "bach.abs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 182.73728813559319, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 629.0, 154.474576271186379, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.4375, 58.73728813559319, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 547.0, 82.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.4375, 382.73728813559319, 99.0, 22.0 ],
					"text" : "12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.4375, 295.0, 63.0, 22.0 ],
					"text" : "bach.x2dx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 295.0, 66.0, 22.0 ],
					"text" : "bach.* 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 260.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.666606903076172, 58.73728813559319, 280.0, 83.0 ],
					"text" : "APPLY-INTERVAL-SUM-RULE [1] outputs a solution having the sum of all intervals equal to the value put in 'sum' [a].\n\nEvaluate the APPLY box [2] and see that the result is equal to the defined value."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 445.0, 43.0 ],
					"text" : "Apply-interval-sum rule"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.25, 237.0, 29.5, 22.0 ],
					"text" : "12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 54.625, 237.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.625, 208.000000000000028, 77.0, 22.0 ],
					"text" : "loadmess 56"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 424.5, 288.0, 584.9375, 288.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 584.9375, 376.368644067796595, 664.9375, 376.368644067796595 ],
					"source" : [ "obj-24", 0 ]
				}
