...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 463.0, 31.0, 21.0 ],
					"text" : "<——"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 708.0, 242.0, 74.0, 20.0 ],
					"text" : "PMCdomain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 106.0, 334.0, 34.0 ],
					"text" : "In [2] we define how many elements\n(or variables) will constitute the solutions."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 428.0, 443.0, 85.0, 20.0 ],
...
,
					"patching_rect" : [ 306.0, 317.0, 52.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 306.0, 345.0, 161.0, 91.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 0,
					"showscrollbar" : 0,
					"showstems" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 158.0, 284.0, 85.0, 20.0 ],
					"text" : "bach.ezmidiplay"
				}
...
,
					"patching_rect" : [ 49.0, 186.0, 52.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 49.0, 212.0, 146.0, 68.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 0,
					"showscrollbar" : 0,
					"showstems" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 119.0, 175.0, 20.0 ],
					"text" : "<= Type 'v' to evaluate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 449.0, 196.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 462.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 3.0 ],
					"patching_rect" : [ 145.0, 367.0, 25.170344022373683, 25.71795654296875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 242.0, 384.0, 62.0 ],
					"text" : "In practice, the function of PMCdomain is to repeat\nthe list of candidates [1] N times in order to build\nthe domain or search space, where N is the length\nof the solution (no. of variables)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 3.0 ],
					"patching_rect" : [ 153.0, 150.0, 25.170344022373683, 25.71795654296875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.0, 145.0, 70.0, 22.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 687.0, 389.0, 42.0, 18.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 626.0, 356.0, 217.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 626.0, 389.0, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 112.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 325.0, 89.0, 22.0 ],
					"text" : "loadmess set 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 152.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 29.0, 356.0, 107.0, 47.0 ],
					"varname" : "bp1593223139122",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 306.0, 243.0, 161.0, 60.0 ],
					"varname" : "bp402328429685",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 306.0, 174.0, 356.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 37.0, 384.0, 48.0 ],
					"text" : "In [1] we set a list of midi values (the candidates)\nrepresenting the seven notes in a C major scale. \nThe bach.roll is only there for visualization."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 38.5, 416.0, 284.558331668376923, 416.0, 284.558331668376923, 162.0, 315.5, 162.0 ],
					"order" : 1,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 315.5, 251.0, 315.5, 251.0 ],
					"source" : [ "obj-2", 0 ]
				}
