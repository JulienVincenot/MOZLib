...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 341.0, 608.0, 48.0 ],
					"text" : "2) 'not-length-repetition-rule' strictly forbids subgroups in the whole solution\n    to have repeated lengths. Just like the previous rule, this one can be compared\n    with the classic 'no-repetition-rule', but for group lengths."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 341.0, 211.0, 20.0 ],
					"text" : "'not-length-repetition-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 249.0, 644.0, 48.0 ],
					"text" : "1) 'not-consecutive-equal-length-rule' prevents the lengths of two consecutive\n    subgroups from being equal. It acts pretty much like the 'no-local-repetition-rule',\n    but for group lengths."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 139.5, 615.0, 34.0 ],
					"text" : "Now open the 'rules' subpatcher. In this example, we present three rules to control\nthe length of sublists in a solution, i.e. the number of notes in successive chords."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 34.0, 608.0, 48.0 ],
					"text" : "First, let's take a quick look inside the 'chord-candidates' subpatcher.\nHere we generate a total of 60 random chords of various lengths (between 2 and 7),\nusing midi notes between 60 and 72. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 174.928571428571416, 556.0, 92.0, 21.0 ],
...
,
					"patching_rect" : [ 9.0, 387.26271186440681, 52.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"padafterclef" : 18.0,
					"patching_rect" : [ 9.0, 416.26271186440681, 212.0, 133.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 0,
					"showscrollbar" : 0,
					"showstems" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 439.0, 175.0, 20.0 ],
					"text" : "'length-sub-group-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 249.0, 261.0, 20.0 ],
					"text" : "'not-consecutive-equal-length-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 834.0, 54.0, 42.0, 18.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 773.0, 21.0, 217.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 773.0, 54.0, 51.0, 18.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 106.662109375, 54.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 298.0, 135.662109375, 71.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 136.662109375, 204.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 225.019043375000024, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 74.0, 354.0, 76.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 387.0, 76.0, 22.0 ],
					"text" : "6 5 3 7"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 126.5, 298.0, 128.0, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "bang" ],
									"patching_rect" : [ 126.5, 331.0, 237.0, 22.0 ],
									"text" : "bach.urn @autoclear 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 126.5, 240.0, 237.0, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 126.5, 269.0, 131.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.5, 365.0, 336.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80300
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 178.0, 95.5, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 126.5, 205.0, 259.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 135.0, 101.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 70.0, 77.0, 22.0 ],
									"text" : "loadmess 60"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 101.0, 65.0, 22.0 ],
									"text" : "2 3 4 5 6 7"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 136.0, 358.5, 217.5, 358.5 ],
									"source" : [ "obj-18", 0 ]
								}
...
,
					"patching_rect" : [ 9.0, 47.0, 111.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 203.0, 161.500000000000028, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 97.000000000000057, 90.0, 22.0 ],
					"text" : "loadmess 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 130.262711864406782, 87.0, 29.237288135593246 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 106.0, 89.0, 22.0 ],
					"text" : "loadmess set 4"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 2.0, 3.0 ],
									"patching_rect" : [ 829.0, 413.0, 25.170344022373683, 25.71795654296875 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 2.0, 3.0 ],
									"patching_rect" : [ 374.0, 449.0, 25.170344022373683, 25.71795654296875 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 2.0, 3.0 ],
									"patching_rect" : [ 374.0, 187.28204345703125, 25.170344022373683, 25.71795654296875 ],
									"viewvisibility" : 1
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 182.5, 69.0, 22.0 ],
													"text" : "bach.round"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 155.5, 109.0, 22.0 ],
													"text" : "bach.autoscale 2 6"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 127.5, 134.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
													"text" : "bach.pick 2 @unwrap 0"
												}
...
,
									"patching_rect" : [ 711.0, 324.5, 53.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 627.0, 179.5, 67.0, 22.0 ],
									"text" : "sample 1 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 795.0, 324.5, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 471.0, 140.0, 94.0, 22.0 ],
									"text" : "prepend bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 206.333333333333314, 45.0, 594.0, 22.0 ],
									"text" : "unjoin 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 513.125, 227.0, 77.0, 22.0 ],
									"text" : "loadmess 17"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 471.0, 387.0, 356.0, 203.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 215.833333333333314, 156.0, 25.5, 156.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 599.166666666666629, 103.0, 480.5, 103.0 ],
									"source" : [ "obj-24", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-16", 0 ],
									"midpoints" : [ 407.5, 372.0, 287.5, 372.0 ],
									"source" : [ "obj-24", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 804.5, 356.5, 829.5, 356.5, 829.5, 168.5, 636.5, 168.5 ],
									"source" : [ "obj-26", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"midpoints" : [ 25.5, 662.0, 457.0, 662.0, 457.0, 376.0, 480.5, 376.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 9.0, 191.237288135593218, 213.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 308.0, 64.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 13.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 133.0, 107.0, 47.0 ],
					"varname" : "bp67044389737",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 243.0, 161.0, 60.0 ],
					"varname" : "bp831940158940",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.0, 439.0, 637.0, 76.0 ],
					"text" : "3) Finally, 'length-sub-group-rule' obliges subgroups in the solution to follow a fixed\n   sequence of lengths according to the list given in the 'lengths' argument.\n \n   The list of lengths can also be provided by sampling a BPF/bach.slot : just click\n   the sample message or move points in the bach.slot to see how it affects the result."
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 18.5, 333.5, 18.5, 338.0, 83.5, 338.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 83.5, 380.533333333333303, 140.5, 380.533333333333303 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 280.5, 186.000000000000057, 301.5, 186.000000000000057, 301.5, 123.000000000000057, 212.5, 123.000000000000057 ],
					"source" : [ "obj-36", 1 ]
				}
