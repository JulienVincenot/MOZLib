...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 362.0, 131.0, 20.0 ],
					"text" : "'not-member-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 362.0, 536.0, 34.0 ],
					"text" : "2) 'not-member-rule' does the opposite,\n    i.e. it forbids elements in the solution to belong to the given list."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 276.0, 102.0, 20.0 ],
					"text" : "'member-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 276.0, 478.0, 34.0 ],
					"text" : "1) 'member-rule' forces all the elements in the solution\n    to belong to a list of elements given in the first argument. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 109.0, 601.0, 48.0 ],
					"text" : "Member rules force the solution to have (or not) certain predetermined elements.\nThey refer to the classic MEMBER function in Lisp, which checks if an atom belongs\nor not to a list."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 472.0, 42.0, 18.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 659.0, 450.0, 217.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 659.0, 472.0, 51.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 122.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 455.0, 161.875, 22.0 ],
					"text" : "1 2 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 224.0, 229.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 167.0, 90.0, 22.0 ],
					"text" : "loadmess 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 224.0, 195.0, 57.0, 29.237288135593246 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 167.0, 89.0, 22.0 ],
					"text" : "loadmess set 4"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.125, 127.0, 77.0, 22.0 ],
									"text" : "loadmess 27"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 183.333333333333314, 43.0, 388.999999999999943, 22.0 ],
									"text" : "unjoin 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.333333333333314, 11.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.333333333333314, 72.0, 94.0, 22.0 ],
									"text" : "prepend bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.125, 403.0, 77.0, 22.0 ],
									"text" : "loadmess 28"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 673.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 192.833333333333314, 153.0, 25.5, 153.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 287.5, 442.5, 25.5, 442.5 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 377.833333333333258, 372.0, 287.5, 372.0 ],
									"source" : [ "obj-24", 1 ]
								}
...
,
					"patching_rect" : [ 38.0, 273.0, 205.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 414.0, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 38.0, 82.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 38.0, 200.0, 107.0, 47.0 ],
					"varname" : "bp1571689962877",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 38.0, 349.0, 161.0, 60.0 ],
					"varname" : "bp1177450404225",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 47.5, 444.966666666666697, 190.375, 444.966666666666697 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 301.5, 257.5, 322.5, 257.5, 322.5, 187.5, 233.5, 187.5 ],
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-15::obj-2::obj-85" : [ "live.text", "live.text", 0 ],
