...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 370.0, 319.0, 20.0 ],
					"text" : "2) 'not-lower-than-rule' does the opposite."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 265.5, 464.0, 34.0 ],
					"presentation_linecount" : 2,
					"text" : "1) 'not-higher-than-rule' forbids any element of the solution\n    to be higher than the value given in the 'limit' argument. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 370.0, 160.0, 20.0 ],
					"text" : "'not-lower-than-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.0, 265.5, 167.0, 20.0 ],
					"text" : "'not-higher-than-rule'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 110.0, 623.0, 20.0 ],
					"text" : "The following rules impose a minimum or maximum value for variables in the solution :"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 756.0, 73.0, 42.0, 18.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 695.0, 40.0, 217.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 695.0, 73.0, 51.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 109.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 476.0, 161.875, 22.0 ],
					"text" : "5 6 3 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 236.0, 229.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 163.0, 90.0, 22.0 ],
					"text" : "loadmess 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 194.0, 57.0, 29.237288135593246 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 163.0, 89.0, 22.0 ],
					"text" : "loadmess set 4"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 2.0, 3.0 ],
									"patching_rect" : [ 138.0, 520.141021728515625, 25.170344022373683, 25.71795654296875 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 2.0, 3.0 ],
									"patching_rect" : [ 138.0, 232.141021728515625, 25.170344022373683, 25.71795654296875 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 206.333333333333314, 45.0, 388.999999999999943, 22.0 ],
									"text" : "unjoin 2"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 400.833333333333258, 372.0, 287.5, 372.0 ],
									"source" : [ "obj-24", 1 ]
								}
...
,
					"patching_rect" : [ 33.0, 263.0, 221.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 435.0, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 33.0, 64.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 199.0, 107.0, 47.0 ],
					"varname" : "bp181769075983",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 350.0, 161.0, 60.0 ],
					"varname" : "bp1148794737967",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 42.5, 465.966666666666697, 185.375, 465.966666666666697 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 313.5, 254.5, 334.5, 254.5, 334.5, 187.500000000000028, 245.5, 187.500000000000028 ],
					"source" : [ "obj-36", 1 ]
				}
