...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 216.0, 471.0, 48.0 ],
					"text" : "Evaluate with the 'v' key and check the result.\nWithin each sub-group of length 3 (highlighted with bach.group),\nthere is no repeated element."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 3.0 ],
					"patching_rect" : [ 65.625, 344.28204345703125, 25.170344022373683, 25.71795654296875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.0, 100.5, 543.0, 20.0 ],
					"text" : "This rule does not allow any repeated element inside of a given sub-group."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 813.666606903076172, 78.0, 42.0, 18.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 752.666606903076172, 45.0, 125.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 752.666606903076172, 78.0, 56.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 205.0, 74.0, 34.0 ],
					"text" : "sub-group\nlength"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 70.625, 236.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 123.0, 242.0, 31.0, 22.0 ],
					"text" : "int 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 184.0, 70.0, 22.0 ],
					"text" : "loadmess 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 211.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 376.0, 85.0, 22.0 ],
					"text" : "prepend count"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 412.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.625, 210.5, 77.0, 22.0 ],
					"text" : "loadmess 12"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 39.0, 269.0, 356.0, 203.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 450.0, 179.0, 22.0 ],
					"text" : "[ 3 0 4 ] [ 1 2 6 ] [ 0 4 1 ] [ 5 0 4 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 100.0, 89.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 128.0, 118.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
					"text" : "bach.arithmser 0 6 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 376.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 39.0, 100.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 39.0, 159.0, 107.0, 47.0 ],
					"varname" : "bp662766328617",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 510.0, 307.0, 161.0, 60.0 ],
					"varname" : "bp210755547771",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 158.0, 579.0, 20.0 ],
					"text" : "The 'sub-group-length' argument determines the length of the desired sub-group."
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 205.5, 236.75, 132.5, 236.75 ],
					"order" : 1,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 205.5, 255.0, 421.5, 255.0 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 48.5, 482.0, 502.0, 482.0, 502.0, 300.0, 519.5, 300.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 519.5, 444.5, 679.5, 444.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 421.5, 404.5, 519.5, 404.5 ],
					"source" : [ "obj-6", 0 ]
				}
