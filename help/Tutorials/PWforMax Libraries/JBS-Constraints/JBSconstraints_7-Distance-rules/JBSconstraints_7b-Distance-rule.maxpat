...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.125, 168.0, 83.0, 22.0 ],
					"text" : "loadmess 103"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 192.0, 356.0, 203.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 517.0, 93.0, 22.0 ],
					"text" : "9 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 79.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 47.202096939086914, 89.0, 22.0 ],
					"text" : "loadmess set 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 476.0, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 115.618644067796652, 107.0, 47.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 410.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 209.202096939086914, 365.0, 160.0 ],
					"text" : "DISTANCE-RULE [1] is a morphological rule, based on the DISTANCE function of the Morphologie library.\n\nIt asks the engine for solutions having a given 'distance' [a] with the pattern set in [b]. The distance is given as a percentage. Here 50 means the result has to be under 50% distance from the model '(1 2 3).\n\nIn 'which?' [c] you can choose if you want an equal distance '=', a smaller distance '<' or a bigger distance '>'."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 255.0, 43.0 ],
					"text" : "Distance rule"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 31.5, 506.0, 105.5, 506.0 ],
					"source" : [ "obj-17", 0 ]
				}
