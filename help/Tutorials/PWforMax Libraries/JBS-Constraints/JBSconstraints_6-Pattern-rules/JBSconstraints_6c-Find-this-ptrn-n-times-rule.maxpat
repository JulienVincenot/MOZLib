...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 75.0, 63.0, 22.0 ],
					"text" : "collapse 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 75.0, 65.0, 22.0 ],
					"text" : "6100 6700"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 272.0, 49.381355932203348, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 100.0, 151.0, 202.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 159.0, 80.0, 22.0 ],
									"text" : "lisp.quickeval"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 130.0, 256.0, 22.0 ],
									"text" : "lisp.expr morphologie::ptrn-find l 'nil @trigger 1"
								}
...
,
					"patching_rect" : [ 106.0, 318.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 347.0, 259.0, 22.0 ],
					"text" : "[ [ 61 67 ] 2 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.4375, 226.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 517.0, 250.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 47.202096939086914, 89.0, 22.0 ],
					"text" : "loadmess set 9"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.0, 95.0, 64.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80105
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.0, 67.0, 65.0, 22.0 ],
									"text" : "bach./ 100"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 205.0, 356.0, 203.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 464.0, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 2 ],
									"midpoints" : [ 151.5, 184.0, 109.75, 184.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 57.125, 132.5, 151.5, 132.5 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 219.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 487.4375, 79.202096939086914, 220.0, 122.0 ],
					"text" : "FIND-THIS-PTRN-N-TIMES-RULE [1] looks for a solution including the precise pattern you ask in 'pattern' input [a].\n\nIn 'repeated-ptrn' [b] you have to put how many times you want this pattern to be repeated in the solution."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Find-this-ptrn-n-times rule"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 281.5, 308.202096939086914, 198.5, 308.202096939086914, 198.5, 156.237288135593218, 173.5, 156.237288135593218 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 314.5, 115.5, 314.5 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 115.5, 343.0, 355.5, 343.0 ],
					"source" : [ "obj-32", 0 ]
				}
