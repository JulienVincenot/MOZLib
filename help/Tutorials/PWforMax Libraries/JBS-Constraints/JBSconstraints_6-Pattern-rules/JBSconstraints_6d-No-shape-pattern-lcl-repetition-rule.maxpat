...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.4375, 294.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 507.0, 318.0, 172.0, 56.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 327.0, 432.0, 247.0, 47.0 ],
									"text" : "A single PMCrule module can actually accept multiple rules. Open the abstraction to see how to these rules were generated."
								}

							}
, 							{
								"box" : 								{
									"fontsize" : 19.355705655506572,
									"id" : "obj-66",
									"maxclass" : "newobj",
									"numinlets" : 0,
									"numoutlets" : 1,
...
,
										"classnamespace" : "box",
										"rect" : [ -208.0, -1001.0, 1122.0, 893.0 ],
										"bglocked" : 0,
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 619.0, 704.0, 29.5, 22.0 ],
													"text" : "t b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 255.0, 55.0, 22.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"versionnumber" : 80105
													}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 209.5, 63.0, 67.0, 22.0 ],
													"text" : "sample 1 5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 209.5, 31.0, 61.0, 22.0 ],
													"text" : "delay 500"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 209.5, 5.0, 58.0, 22.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 238.5, 786.555555555555657, 868.5, 22.0 ],
													"text" : "[ OMCS::I1 [ ?IF [ MEMBER OMCS::I1 ' [ 60 ] :TEST 'EQUALP ] ] ] [ OMCS::I2 [ ?IF [ MEMBER OMCS::I2 ' [ 66 ] :TEST 'EQUALP ] ] ] [ OMCS::I3 [ ?IF [ MEMBER OMCS::I3 ' [ 72 ] :TEST 'EQUALP ] ] ] [ OMCS::I4 [ ?IF [ MEMBER OMCS::I4 ' [ 66 ] :TEST 'EQUALP ] ] ] [ OMCS::I5 [ ?IF [ MEMBER OMCS::I5 ' [ 60 ] :TEST 'EQUALP ] ] ] [ OMCS::I6 [ ?IF [ MEMBER OMCS::I6 ' [ 48 ] :TEST 'EQUALP ] ] ] [ OMCS::I7 [ ?IF [ MEMBER OMCS::I7 ' [ 66 ] :TEST 'EQUALP ] ] ] [ OMCS::I8 [ ?IF [ MEMBER OMCS::I8 ' [ 84 ] :TEST 'EQUALP ] ] ] [ OMCS::I9 [ ?IF [ MEMBER OMCS::I9 ' [ 66 ] :TEST 'EQUALP ] ] ] [ OMCS::I10 [ ?IF [ MEMBER OMCS::I10 ' [ 48 ] :TEST 'EQUALP ] ] ]"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 742.0, 513.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 21.5, 197.0, 662.0, 22.0 ],
													"text" : "t l l l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 845.5, 618.25, 241.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 845.5, 517.5, 78.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 904.5, 546.75, 29.5, 22.0 ],
													"text" : "j"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 845.5, 546.75, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 845.5, 576.0, 197.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 664.5, 360.138461681512695, 297.0, 22.0 ],
													"text" : "t b b b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 904.5, 420.0, 29.5, 22.0 ],
													"text" : "j"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 712.0, 420.0, 181.0, 49.0 ],
													"text" : "lisp.expr jbs-constraints::make-i1-from-to 6 10"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 904.5, 447.0, 57.0, 22.0 ],
													"text" : "lisp.for-in"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 440.0, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 664.5, 592.0, 157.0, 22.0 ],
													"text" : "lisp.iterate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 845.5, 660.5, 97.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 481.999568074214721, 113.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 669.0, 64.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 629.5, 80.0, 22.0 ],
													"text" : "lisp.quickeval"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 351.5, 618.25, 241.0, 35.0 ],
													"text" : "lisp.expr jbs-constraints::collect-true/false-rules rule1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "bang" ],
													"patching_rect" : [ 351.5, 517.5, 78.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 410.5, 546.75, 29.5, 22.0 ],
													"text" : "j"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 351.5, 546.75, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 351.5, 576.0, 197.0, 35.0 ],
													"text" : "lisp.expr jbs-constraints::index-rule index value :true/false 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "bang", "bang", "bang", "" ],
													"patching_rect" : [ 170.5, 360.138461681512695, 297.0, 22.0 ],
													"text" : "t b b b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 410.5, 420.0, 29.5, 22.0 ],
													"text" : "j"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 206.0, 420.0, 181.0, 49.0 ],
													"text" : "lisp.expr jbs-constraints::make-i1-from-to 1 5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 410.5, 447.0, 57.0, 22.0 ],
													"text" : "lisp.for-in"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 440.0, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 170.5, 592.0, 157.0, 22.0 ],
													"text" : "lisp.iterate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 351.5, 660.5, 97.0, 22.0 ],
													"text" : "lisp.expr collect i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 481.999568074214721, 113.0, 22.0 ],
													"text" : "lisp.for-in @quote 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 669.0, 64.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 629.5, 80.0, 22.0 ],
													"text" : "lisp.quickeval"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 405.0, 53.0, 22.0 ],
													"text" : "1 1 -1 -1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 255.0, 70.0, 22.0 ],
													"text" : "lisp.quote 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 380.0, 93.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 345.0, 80.0, 22.0 ],
													"text" : "lisp.quickeval"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 288.0, 136.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 327.0, 69.0, 22.0 ],
													"text" : "bach.round"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 327.0, 69.0, 22.0 ],
													"text" : "bach.round"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 664.5, 288.0, 123.0, 22.0 ],
													"text" : "bach.autoscale 48 84"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 288.0, 123.0, 22.0 ],
													"text" : "bach.autoscale 60 72"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 261.0, 157.0, 73.0, 22.0 ],
													"saved_object_attributes" : 													{
														"versionnumber" : 80105
													}
,
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 170.5, 840.555541999999946, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 270.5, 187.5, 31.0, 187.5 ],
													"source" : [ "obj-11", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 721.5, 477.999784037107361, 768.0, 477.999784037107361 ],
													"source" : [ "obj-39", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-1", 0 ],
													"midpoints" : [ 628.5, 729.0, 603.0, 729.0, 603.0, 240.0, 180.0, 240.0 ],
													"source" : [ "obj-4", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 914.0, 504.0, 789.0, 504.0, 789.0, 579.0, 743.0, 579.0 ],
													"source" : [ "obj-40", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 420.0, 504.0, 294.0, 504.0, 294.0, 579.0, 249.0, 579.0 ],
													"source" : [ "obj-47", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 215.5, 477.999784037107361, 274.0, 477.999784037107361 ],
													"source" : [ "obj-48", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-1", 0 ],
													"midpoints" : [ 352.5, 236.5, 180.0, 236.5 ],
													"source" : [ "obj-54", 1 ]
												}
...
,
									"patching_rect" : [ 302.0, 377.992248062015506, 208.0, 30.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 416.0, 305.0, 79.0 ],
									"varname" : "pmc.rule[1]",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 15.0, 111.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.25, 109.0, 29.5, 22.0 ],
									"text" : "5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 47.625, 78.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.625, 50.0, 77.0, 22.0 ],
									"text" : "loadmess 99"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 136.0, 356.0, 203.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 584.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 57.125, 104.0, 109.75, 104.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
,
					"patching_rect" : [ 23.0, 176.237288135593218, 123.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 318.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 100.381355932203348, 107.0, 47.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 242.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.4375, 65.0, 413.0, 237.0 ],
					"text" : "No-shape-pattern-lcl-repetition-rule [1] \nforbids a solution to include two consecutive patterns \ndescribed in term of Morphologie's direct-analysis.\n\nIn this example, the rule is bypassed on opening. \nWe generate in parallel a series of Index-rules \nin a Iterate loop (Lisp-side), forcing the result \nto include, precisely, such a scenario of a pattern \nlocally repeated.\n\nHere the direct-analysis pattern is 1 1 -1 -1, given in arbitrary octaves. Actual notes are not important, \nwhat really matters is the shape they follow \n(here \"up up down down\").\n\nFirst evaluate the patch to see a result, then re-enable \nthe No-shape-pattern-lcl-repetition-rule to confirm \nthat no result can be found in these conditions."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "No-shape-pattern-lcl-repetition rule"
				}
