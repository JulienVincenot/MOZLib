...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.666606903076172, 230.537162162162161, 172.0, 21.0 ],
					"text" : "Rule numbers 96 to 102"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.666606903076172, 102.5, 386.0, 83.0 ],
					"text" : "The following rules are useful to control and generate patterns. \nBy pattern I mean a type of theme, of recurring events, or of objects, sometimes referred to as elements of a set. Patterns are based on repetition. Without repetitions there is no pattern."
				}
