...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 18.0, 415.0, 60.0 ],
									"text" : "reflexion en cours\n\ncount-this-note pourrait effectivement\ndisparaitre au profit de Generic > count-this-element"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 363.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.4375, 277.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 301.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 328.0, 123.5, 22.0 ],
					"text" : "0 0 1 8 8 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 301.0, 104.0, 22.0 ],
					"text" : "bach.% 12 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 106.0, 336.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 336.0, 66.0, 22.0 ],
					"text" : "bach.* 100"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 371.0, 683.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 224.0, 151.737288135593246, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 92.237288135593275, 90.0, 22.0 ],
					"text" : "loadmess 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 224.0, 120.5, 61.5, 29.237288135593246 ],
					"rows" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.125, 339.0, 77.0, 22.0 ],
									"text" : "loadmess 76"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 377.0, 356.0, 203.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 198.0, 339.0, 94.0, 22.0 ],
									"text" : "prepend bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 608.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 207.5, 369.0, 25.5, 369.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 25.5, 350.0, 25.5, 350.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 339.833333333333258, 75.5, 207.5, 75.5 ],
									"source" : [ "obj-24", 1 ]
								}
...
,
					"patching_rect" : [ 23.0, 181.474576271186493, 220.0, 39.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 301.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 227.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 106.0, 380.0, 135.0 ],
					"text" : "This patch shows you how to count a single note or the modulo 12 of a given note.\n\nCOUNT-THIS-NOTE-RULE [1] obliges a solution to have the given note repeated as many times as indicated in 'how-many' in the exact defined octave.\n\nCOUNT-THIS-MODULO-RULE [2] obliges a solution to have a given note repeated many times as indicated in 'how-many', in any possible octave."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Count-this-note/modulo rules"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 32.5, 324.0, 87.0, 324.0, 87.0, 297.0, 115.5, 297.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 301.5, 176.237288135593275, 318.5, 176.237288135593275, 318.5, 113.237288135593275, 233.5, 113.237288135593275 ],
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 115.5, 329.0, 220.0, 329.0 ],
					"source" : [ "obj-6", 0 ]
				}
