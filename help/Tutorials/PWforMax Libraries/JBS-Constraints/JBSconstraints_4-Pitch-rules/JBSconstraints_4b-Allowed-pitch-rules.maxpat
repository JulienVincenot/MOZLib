...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.4375, 245.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 191.0, 269.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 378.0, 205.5, 22.0 ],
					"text" : "2 2 4 2 2 2 2 0 4 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 343.0, 104.0, 22.0 ],
					"text" : "bach.% 12 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 378.0, 166.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 413.0, 683.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 224.5, 133.262711864406725, 87.5, 29.237288135593246 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 107.0, 96.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 556.25, 188.0, 47.0, 22.0 ],
									"text" : "(60 62)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 503.625, 188.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 503.625, 159.0, 77.0, 22.0 ],
									"text" : "loadmess 65"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.25, 378.0, 63.0, 22.0 ],
									"text" : "(60 62 64)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.625, 349.0, 77.0, 22.0 ],
									"text" : "loadmess 64"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.25, 87.0, 63.0, 22.0 ],
									"text" : "(60 62 64)"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 472.0, 228.0, 356.0, 203.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 613.0, 80.0, 94.0, 22.0 ],
									"text" : "prepend bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 206.333333333333314, 45.0, 629.0, 22.0 ],
									"text" : "unjoin 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.625, 58.0, 77.0, 22.0 ],
									"text" : "loadmess 63"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 472.0, 493.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 419.166666666666629, 372.0, 355.5, 372.0 ],
									"source" : [ "obj-24", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 25.5, 639.0, 459.0, 639.0, 459.0, 126.0, 481.5, 126.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 622.5, 123.0, 481.5, 123.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.666606903076172, 59.202096939086914, 432.0, 327.0 ],
					"text" : "ALLOWED-PITCH-RULE [1] forces the solution to be constituted only by pitches indicated in 'pitch' input [a].\nIt differs from MEMBER-RULE because it considers pitches at any octave defined in the candidates.\n\nNOT-ALLOWED-PITCH-RULE [2] does the opposite.\n\nALLOWED-POLARIZED-PITCH-RULE [3] allows only, for a given modulo 12 note, the pitch defined in [a]. \nIn this example, the rule allows only, for the C and D notes, the pitch 60 and 62 and forbids all others.\n\nATTENTION !\nYou can control the results by evaluating both the CHORD-EDITOR and the G-MOD function [4], which reduces any value to its modulo 12.\nFor instance, any C-sharp (49, 61 or 73) will be reduced to 1, any E (52, 64 or 76) will be reduced to 4, and so on...\n\nATTENTION AGAIN !!!\nIf you work with microtones be sure that all pitches you define in [a] are floats.\nThat means that if you admit 60 as a possible note, if you are using microtonal candidates (like quarter of tones for instance) you have to use 60.0 and not simply 60."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 369.0, 43.0 ],
					"text" : "Allowed-pitch rules"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 32.5, 366.0, 87.0, 366.0, 87.0, 339.0, 115.5, 339.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 115.5, 371.0, 302.0, 371.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-15::obj-5::obj-184::obj-120" : [ "textedit[2]", "textedit", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
