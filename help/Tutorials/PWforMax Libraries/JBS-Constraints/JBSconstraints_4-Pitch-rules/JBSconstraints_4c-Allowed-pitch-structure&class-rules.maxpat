...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 384.5, 107.0, 266.0, 100.0 ],
									"text" : "ALLOWED-PITCH-CLASS-SUB-LIST-RULE [3] allows an occurence of a defined pitch class (for instance a minor triad, indicated in 'pitch' input) among other notes in the solution \nSo in this example I'm looking for a solution including a (consecutive) minor triad within a 5 notes chord."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 800.0, 154.0, 295.0, 100.0 ],
									"text" : "ALLOWED-PITCH-CLASS-RULE [2]  creates a solution based on a pitch class (a concept belonging to the set theory) derived from a chord put in [a]. \nIn this case a C-minor triad is entered in [a]. The Multi-PMC will find any solution corresponding to the same class, i.e. at any possible octave, transposition, inversion or arrangement."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.5, 343.0, 290.0, 100.0 ],
									"text" : "ALLOWED-PITCH-STRUCTURE-RULE [1] creates a solution based on the set theory. \nIn this way only the set of pitches indicated in 'pitch' input will be allowed at any octave. \nN.B. : The chord produced will always be complete, or in other words it will always contain all the chosen pitches side by side."
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.666606903076172, 251.0, 258.0, 109.0 ],
					"text" : "This patch shows you three different ways to define the pitches you want within your solution. These rules are based on the concepts of pitch structure and pitch class. \n\nSee Inside the RULES subpatches to know more."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 673.0, 43.0 ],
					"text" : "Allowed-pitch-structure/class rules"
				}
