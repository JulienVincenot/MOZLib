...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.0, 471.508007049560547, 154.0, 22.0 ],
					"text" : "2 8 0 11 10 11 4 6 1 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.0, 446.508007049560547, 104.0, 22.0 ],
					"text" : "bach.% 12 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 109.0, 132.837433879104537, 71.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 300.0, 65.0, 22.0 ],
					"text" : "bach./ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 45.5, 305.0, 22.0 ],
					"text" : "5000 5600 6000 5900 5800 5900 6400 6600 7300 6800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.4375, 355.737288135593303, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 659.0, 379.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.0, 158.837433879104537, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.4375, 294.0, 427.0, 60.0 ],
					"text" : "MK-PROFILE-PITCH-MODULO-RULE [1] asks the engine to put out a list of pitches based on the same modulo 12 sequence than the given profile.\n\nIt creates a variation of a given pitch profile on any octave."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 100.0, 131.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.0, 471.508007049560547, 111.0, 22.0 ],
					"text" : "to_chord zoom 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 494.0, 446.508007049560547, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 471.508007049560547, 66.0, 22.0 ],
					"text" : "bach.* 100"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 502.0, 683.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 446.508007049560547, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"offset" : [ -65.0, -114.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 185.837433879104537, 107.0, 47.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 419.0, 379.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 21.0, 76.0, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Mk-profile-pitch-modulo rule"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 30.5, 594.0, 405.0, 594.0, 405.0, 375.0, 428.5, 375.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 214.5, 326.0, 115.0, 326.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 214.5, 288.0, 192.0, 288.0, 192.0, 125.0, 118.5, 125.0 ],
					"order" : 1,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 428.5, 475.0, 428.5, 475.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 503.5, 469.508007049560547, 638.5, 469.508007049560547 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 503.5, 499.754003524780273, 428.5, 499.754003524780273 ],
					"source" : [ "obj-7", 0 ]
				}
