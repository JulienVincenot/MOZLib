...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 536.0, 317.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.9375, 81.0, 473.0, 122.0 ],
					"text" : "N.B. BE CAREFUL\nThe menu 'which?' defines less, equal or more.\nIf you set <, the calculation is quite fast.\nIf you set =, be sure to have a pair number of candidates in the search space.\nIf you set >, the calculation can be very slow.\n\nIf you don't find a solution in a reasonable amount of time, you may kill the engine (bang right inlet) and start a new evaluation !",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 630.0, 210.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.375, 200.0, 29.5, 22.0 ],
					"text" : ":="
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 54.625, 200.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 345.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.4375, 232.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 681.0, 256.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 345.0, 183.0, 22.0 ],
					"text" : "2 2 3 3 10 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 290.0, 65.0, 22.0 ],
					"text" : "bach.% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 536.0, 316.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 453.0, 345.0, 66.0, 22.0 ],
					"text" : "bach.* 100"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 453.0, 380.0, 683.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 453.0, 290.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80105
					}
,
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 453.0, 216.0, 161.875, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 466.9375, 19.0, 373.999999999999943, 45.0 ],
					"text" : "ANY-NOTE-REPEATED-RULE [1] verifies that any note (modulo 12) in the solution is repeated more, less or exactly the number of time defined in 'times' input."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 426.0, 43.0 ],
					"text" : "Any-note-repeated rule"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.625, 176.0, 77.0, 22.0 ],
					"text" : "loadmess 74"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 234.0, 356.0, 203.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 447.0, 438.0, 447.0, 438.0, 210.0, 462.5, 210.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 462.5, 313.0, 517.0, 313.0, 517.0, 286.0, 545.5, 286.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 545.5, 342.0, 709.5, 342.0 ],
					"source" : [ "obj-28", 0 ]
				}
