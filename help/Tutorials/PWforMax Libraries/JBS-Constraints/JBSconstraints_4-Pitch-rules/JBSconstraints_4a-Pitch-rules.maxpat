...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 735.0, 352.0, 150.0, 20.0 ],
					"text" : "make example with this"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 230.0, 151.0, 202.0 ],
					"varname" : "bp1131938224933",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.0, 470.0, 65.0, 22.0 ],
					"text" : "bach.% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.666606903076172, 230.537162162162161, 165.333393096923828, 21.0 ],
					"text" : "Rule numbers 63 to 81"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.791606903076172, 246.0, 77.0, 22.0 ],
					"text" : "loadmess 63"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 57.0, 276.0, 356.0, 203.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.666606903076172, 140.5, 340.0, 58.0 ],
					"text" : "Just as a reminder : arithmetic modulo 12 is used by musicians, for instance, in consideration of the twelve-tones equal temperament system, where octave and enharmonic equivalency occurs.\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.666606903076172, 66.5, 379.333393096923828, 71.0 ],
					"text" : "The following rules are conceived for pitches. For that reason sometimes this tutorial refers to the modulo 12 (or 24, or 48 if we work with quarter or eighth of tones). Please if you do not know the function g-mod, see the PWGL documentation about it."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 274.0, 43.0 ],
					"text" : "Pitch rules"
				}
		...
		"parameters" : 		{
			"obj-2::obj-184::obj-120" : [ "textedit[5]", "textedit", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
