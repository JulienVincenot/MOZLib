...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.4375, 347.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 319.0, 371.0, 172.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 371.0, 151.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.666606903076172, 120.5, 260.0, 109.0 ],
					"text" : "[1] The INDEX-PITCH-RULE forces a given position ('index' input) in the solution to be occupied by any pitch (at any octave) in the list defined with 'pitch' input.\n\n[2] The NOT-INDEX-PITCH-RULE does the opposite."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.423917060628419, 2.202096939086914, 331.0, 43.0 ],
					"text" : "Index-pitch rules"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-15::obj-4::obj-188::obj-120" : [ "textedit[3]", "textedit", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
