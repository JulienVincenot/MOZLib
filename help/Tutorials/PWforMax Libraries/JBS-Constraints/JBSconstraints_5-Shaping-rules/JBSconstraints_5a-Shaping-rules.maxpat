...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.666606903076172, 66.5, 386.0, 83.0 ],
					"text" : "The following rules have been conceived to control and generate shapes. The concept of shape is at the same time based on BPF representations and on melodic profile representations. In a sense, this part of the library concerns geometrical disposition of a sequence of elements."
				}
