...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.666606903076172, 259.53716216216219, 201.0, 21.0 ],
					"text" : "Rule numbers 104 to 117"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.791606903076172, 208.0, 83.0, 22.0 ],
					"text" : "loadmess 104"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 54.0, 238.0, 356.0, 203.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.666606903076172, 76.5, 473.0, 122.0 ],
					"text" : "This part of the library is dedicated to the control of structures. The notion of a structure is hard to define in this kind of software. In general I make the difference between a list, a sequence and a structure. The interpretation of any phenomenon is articulated under the form of structures. It means here that the rules will generate some sequences but these sequences will be interpreted in function of a given context. In this sense, the same rule here can produce a structure that is meaningful for a rhythm sequence and another that is meaningful for an interval sequence."
				}
