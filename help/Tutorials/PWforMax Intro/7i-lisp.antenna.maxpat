...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 228.5, 48.0, 19.0 ],
					"text" : "type S"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 230.0, 48.0, 19.0 ],
					"text" : "type V"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 255.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 231.0, 228.5, 68.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 87.0, 717.0, 32.0 ],
					"text" : "That's why in PWforMax you cannot easily select a Lisp object in the middle of your patch and get its value\nto understand better how to fix a bug or what to do next. Unless there is another way...?"
				}
...
, 			{
				"box" : 				{
					"fontface" : 2,
					"fontname" : "Menlo Regular",
					"fontsize" : 29.520188284806387,
					"id" : "obj-9",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 393.0, 419.0, 42.5, 45.0 ],
					"text" : "☝️",
...
, 			{
				"box" : 				{
					"fontface" : 2,
					"fontname" : "Menlo Regular",
					"fontsize" : 18.40239394472804,
					"id" : "obj-4",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 422.0, 396.0, 28.0 ],
					"text" : "no seriously...    please open it !",
					"textcolor" : [ 1.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 466.0, 494.0, 37.0 ],
					"text" : "lisp.antenna cannot work in the context of MOZ'Lib Overview...\nbut it works perfectly when used in a top level patch !"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.0, 350.0, 53.0, 22.0 ],
									"text" : "lisp.print"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 16.0, 260.0, 101.0, 22.0 ],
									"text" : "t b l b"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 328.0, 91.0, 465.0, 45.0 ],
									"text" : "Just try it : keep evaluating with the v key, and move the cursor\nover the different objects. You'll see the last result of each object\none after the other, just like in the old days of PW(OM)GL."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 272.0, 147.0, 465.0, 32.0 ],
									"text" : "ATTENTION : you STILL need a key_trigger or something else that bangs\nthe whole patch from the top. This is still Max after all...!"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 241.0, 47.0, 483.0, 33.0 ],
									"text" : "This object allows to retrieve intermediary results of a PWforMax patch\nby simply hovering the mouse on the Lisp scripting objects. Seriously 🤯"
								}
...
, 							{
								"box" : 								{
									"fontname" : "Menlo Regular",
									"fontsize" : 16.069100141952653,
									"id" : "obj-36",
									"maxclass" : "comment",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 239.0, 23.0, 125.0, 25.0 ],
									"text" : "lisp.antenna"
								}
...
,
					"patching_rect" : [ 288.0, 371.0, 207.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 451.0, 250.0, 366.0, 32.0 ],
					"text" : "You can also give another character to trigger\nother things in your patch, like stopping something..."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 413.0, 254.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 413.0, 227.0, 77.0, 22.0 ],
					"text" : "key_trigger s"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.0, 183.0, 399.0, 32.0 ],
					"text" : "This old MOZ utility can come in handy if you are addicted\nto triggering things with the letter 'v' for some reason..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 159.0, 115.0, 25.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.666606903076172, 1.508007049560547, 388.0, 43.0 ],
					"text" : "Old style evaluation"
				}
