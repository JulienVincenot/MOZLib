...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 655.0, 13.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 111.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 55.0, 100.0, 35.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80900
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 400.0, 14.0, 100.0, 22.0 ],
					"text" : "key_trigger"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 404.0, 607.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 400.0, 399.0, 244.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.0, 403.0, 100.0, 22.0 ],
					"text" : "(cr::no-repetition)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.0, 286.0, 241.0, 22.0 ],
					"text" : "(cr::no-syncopation :metric-structure :beats)"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 400.0, 282.0, 244.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 76.0, 241.0, 22.0 ],
					"text" : "(cr::no-repetition)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 569.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80900
					}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 82.0, 233.0, 174.0 ],
					"varname" : "bp1614860935415",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 400.0, 481.0, 205.0, 78.0 ],
					"varname" : "bp1133119099803",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 47.0, 241.0, 22.0 ],
					"text" : "(cr::no-syncopation :metric-structure :beats)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 251.0, 266.0, 22.0 ],
					"text" : "[ #<CLUSTER-ENGINE::RULE {1201515033}> ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 187.0, 100.0, 35.0 ],
