...
,
		"classnamespace" : "box",
		"rect" : [ -219.0, -1001.0, 1160.0, 827.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.666726589202881, 385.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 453.916726589202881, 67.166664004325867, 674.0, 129.0 ],
					"text" : "TODO : \nimplement optional recall from file to keep training\n               (try if it works !)\n\nput normalize / denormalize (public version) in the sources\nso we don't need code_snippet"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.133327841758728, 330.426845995475105, 622.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.133327841758728, 278.0, 475.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.800054430961609, 32.205128284601066, 143.866672158241272, 37.0 ],
					"text" : "Example 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.200016021728516, 587.113372297287015, 312.666674494743347, 137.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 365.133327841758728, 201.00001847743988, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.133327841758728, 276.0, 35.0, 22.0 ],
					"text" : "2 1 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.133327841758728, 270.5, 127.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.133327841758728, 257.00001847743988, 45.0, 20.0 ],
					"text" : "targets"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.000027298927307, 257.00001847743988, 41.0, 20.0 ],
					"text" : "inputs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.133327841758728, 278.0, 77.0, 22.0 ],
					"text" : "(0) (1) (1) (0)"
				}
...
, 			{
				"box" : 				{
					...
					"reg_data_0000000000" : [ "[", "defun", "normalize", "[", "input", "]", "[", "map", "'vector", "[", "lambda", "[", "x", "]", "[", "if", "[", "=", "x", 1, "]", "1.0d0", "-1.0d0", "]", "]", "input", "]", "]", "[", "defun", "denormalize", "[", "output", "]", "[", "if", "[", "plusp", "[", "aref", "output", 0, "]", "]", 1, 0, "]", "]" ],
					"reg_data_count" : [ 1 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.133327841758728, 276.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 453.916726589202881, 410.600003957748413, 29.5, 22.0 ],
					"text" : "1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.666726589202881, 410.600003957748413, 29.5, 22.0 ],
					"text" : "0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.666726589202881, 410.600003957748413, 29.5, 22.0 ],
					"text" : "1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.666726589202881, 410.600003957748413, 29.5, 22.0 ],
					"text" : "0 0"
				}
