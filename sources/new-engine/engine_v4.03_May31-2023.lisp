...
(defun engine_v4.03 (no-variables domain var-type abs-interval? start rulelist heurrulelist mode rnd? read-write-engine-state?)
		;;;;;;;; setup searchspace
...
;;;;;;; load a state of the search engine from file
		...
		(when (= read-write-engine-state? 4)
 		...
 		(when (or (= read-write-engine-state? 2) (= read-write-engine-state? 5))
...
;Example with pitches
(time (engine_v4.03 10001  '(60 62 64 65 67 69 71 72) 'integer *absolute-domain*  nil
	(list 
