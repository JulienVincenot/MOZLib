...
(defun engine_v4.0 (no-variables domain var-type abs-interval? start rulelist heurrulelist mode rnd? read-write-engine-state?)
		;;;;;;;; setup searchspace
...
;;;;;;;;;;;;;;;
		(when (or (= abs-interval? *interval-domain*) (= abs-interval? *absolute-domain*));;set first pitch in solution
	...
	(cond ((= type *basic-domain*) 
		  ...
		  (t
			(list
	 			 ...
	 			 (loop for i from 0 to no-variables
		    		  collect (aref solution i 1)))
		  )))
...
(engine_v4.0 15  '(1/4 -1/8 -1/4) 'ratio *duration-domain*  nil
	(list 
...
(engine_v4.0 5 '(1/4 1/2 3/4 1 1/8 3/2) 'ratio *absolute-domain* 0
	(list 
...
(engine_v4.0 15  '(60 62 64 65 67 69 71 72) 'integer *absolute-domain*  nil
	(list 
...
(engine_v4.0 15  '(1 2 -2 -1)  'integer *interval-domain*  60
	(list 
...
(engine_v4.0 15  '('green 'blue 'red)  't *basic-domain*   nil
	(list 
