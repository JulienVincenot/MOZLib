...
(defun engine_v4.02 (no-variables domain var-type abs-interval? start rulelist heurrulelist mode rnd? read-write-engine-state?)
		;;;;;;;; setup searchspace
...
(engine_v4.02 5 '(1/4 1/2 3/4 1 1/8 3/2) 'ratio *absolute-domain* 0
	(list 
