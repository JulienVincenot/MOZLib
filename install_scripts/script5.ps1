...
invoke-expression 'cmd /c start powershell -Command { echo "Installing unzip for Ubuntu. Please enter your password when prompted" ; wsl sudo apt-get install -y unzip ; wsl chmod +x /mnt/c/Windows/Temp/MOZLib-master/install_scripts/script6.sh ; cd C:\Windows\Temp\MOZLib-master\install_scripts ; bash scrip6.sh }'
