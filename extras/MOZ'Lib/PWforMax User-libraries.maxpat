...
, 			{
				"box" : 				{
					...
					"text" : "Just like in PW/OM/PWGL, libraries can be shared freely among users, hoping to foster a spirit of generosity,\ncuriosity and mutual help among CAC users."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "User libraries can contain folders to store you Max externals, patchers, help files, extras,\ncollections, media, snippets... but what difference with a Max package?"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "To evaluate this function,\nyou need to locate \"moz-user-test\"\n(zipped in /MOZLib/sources/).\nFirst unzip it then move\nthe result folder\nto ~/Documents/Max 8/Packages/\nthen load it here !",
...
, 			{
				"box" : 				{
					...
					"text" : "Note : Each library's 'sources' folder must contain an .asd file in order to specify which Lisp files to load.\nIf you are not sure how to proceed, you can take for example the \"MOZLib-mydemolib\" folder that is ",
					"textcolor" : [ 0.537254901960784, 0.537254901960784, 0.537254901960784, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "User libraries allow users to easily add their own set of Lisp functions and systems on top of the default\nones provided with MOZ'Lib / PWforMax (Common Lisp, SBCL, PW family, guest libraries...)."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 660.5, 1144.0, 94.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 682.0, 1072.0, 38.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 99.0, 690.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 69.0, 625.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 283.0, 909.0, 71.0, 22.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 283.0, 852.0, 41.0, 22.0 ],
									"text" : "unjoin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 283.0, 883.0, 40.0, 22.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 283.0, 819.0, 40.0, 22.0 ],
									"text" : "atoi"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 114.0, 1115.0, 99.0, 35.0 ],
									"text" : "combine /mnt/c l @triggers 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 245.0, 975.0, 50.0, 22.0 ],
									"text" : "Max 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 283.0, 937.0, 79.0, 22.0 ],
									"text" : "prepend Max"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 283.0, 791.0, 61.0, 22.0 ],
									"text" : "sprintf %x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 338.0, 1088.0, 296.0, 22.0 ],
									"text" : "/Packages/MOZLib/sources/_LOAD_user-libraries.lisp"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 1176.0, 394.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 245.0, 1013.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.0, 923.0, 83.0, 22.0 ],
									"text" : "~/Documents/"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 69.0, 1013.0, 93.0, 22.0 ],
									"text" : "regexp .+:(/.+)$"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 69.0, 730.0, 371.0, 22.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.0, 952.0, 77.0, 22.0 ],
									"text" : "absolutepath"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 88.0, 1056.0, 73.0, 22.0 ],
									"text" : "mac_or_win"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 88.0, 1080.0, 125.0, 22.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 680.0, 840.0, 135.0, 22.0 ],
									"text" : "lisp.expr pw::mat-trans l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 681.0, 804.0, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 772.0, 233.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 659.0, 147.0, 22.0 ],
									"text" : "lisp.expr intern x :keyword"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 683.0, 599.0, 179.0, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 631.0, 138.0, 22.0 ],
									"text" : "lisp.expr symbol-name x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 687.0, 79.0, 22.0 ],
									"text" : "lisp.lambda x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 717.0, 183.0, 35.0 ],
									"text" : "lisp.expr mapcar #'pw::extract-system-name l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 682.0, 1018.0, 100.0, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 950.0, 818.0, 64.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 682.5, 1192.0, 125.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80900
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 683.0, 427.5, 174.0, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 519.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 475.0, 123.0, 35.0 ],
									"text" : "lisp.expr mapcar #'pw::find-asd-files l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 681.0, 889.0, 100.0, 22.0 ],
									"text" : "lisp.quickeval"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 551.0, 163.0, 35.0 ],
									"text" : "lisp.expr mapcar #'pw::extract-system-name l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 683.0, 403.5, 70.0, 22.0 ],
									"text" : "lisp.quote 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 683.0, 360.0, 123.0, 35.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80900
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 344.5, 71.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 344.5, 139.0, 90.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 437.0, 139.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 532.0, 107.0, 79.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80900
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 532.0, 71.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 330.0, 564.0, 72.0, 22.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 252.0, 107.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 614.0, 490.0, 50.0, 22.0 ],
									"text" : "set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 331.0, 360.0, 302.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 330.0, 467.0, 121.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80900
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 437.0, 186.0, 29.5, 22.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 192.0, 166.0, 34.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 181.0, 71.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 330.0, 519.0, 40.0, 22.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 331.0, 421.0, 123.0, 35.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80900
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 760.0, 161.0, 29.5, 22.0 ],
									"text" : "null"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 331.0, 320.0, 98.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 450.0, 71.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 760.0, 71.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.0, 605.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 340.5, 352.0, 458.0, 352.0, 458.0, 244.0, 438.5, 244.0 ],
									"order" : 1,
									"source" : [ "obj-108", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 340.5, 345.0, 692.5, 345.0 ],
									"order" : 0,
									"source" : [ "obj-108", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 457.0, 218.0, 340.5, 218.0 ],
									"source" : [ "obj-19", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 254.5, 1161.259399499999972, 285.0, 1161.259399499999972 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 623.5, 594.0, 339.5, 594.0 ],
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 541.5, 131.0, 446.5, 131.0 ],
									"source" : [ "obj-48", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 430.5, 1072.0, 347.5, 1072.0 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 97.0, 1049.5, 203.5, 1049.5 ],
									"source" : [ "obj-97", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"text" : "or simply drag all your libraries\nin there !",
					"textjustification" : 1
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 217.0, 443.0, 219.0, 22.0 ],
									"text" : "make_path_once-create-user-folder  #0",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 17.5, 533.0, 33.0, 22.0 ],
									"saved_object_attributes" : 									{
										"shell" : "(default)"
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.5, 465.0, 140.0, 22.0 ],
									"text" : "sprintf %s/MOZLib-User/"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.5, 497.0, 99.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 39.0, 6.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 482.0, 386.0, 210.0, 22.0 ],
													"text" : "/Users/julienvincenot"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 273.0, 386.0, 210.0, 22.0 ],
													"text" : "/Users/julienvincenot"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 432.0, 344.0, 29.0, 22.0 ],
													"text" : "thru"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "int", "bang", "bang" ],
													"patching_rect" : [ 234.0, 226.0, 73.0, 22.0 ],
													"text" : "mac_or_win"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 432.0, 418.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 234.0, 344.0, 29.0, 22.0 ],
													"text" : "thru"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 83.0, 171.0, 614.0, 22.0 ],
													"text" : "/Users/julienvincenot"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 5,
													"outlettype" : [ "", "", "", "", "" ],
													"patching_rect" : [ 40.0, 129.0, 93.0, 22.0 ],
													"text" : "regexp .+:(/.+)$"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 39.0, 94.0, 77.0, 22.0 ],
													"text" : "absolutepath"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 251.0, 298.0, 141.0, 22.0 ],
													"text" : "combine C: l @triggers 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 234.0, 258.0, 158.0, 22.0 ],
													"text" : "gate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 446.0, 285.0, 161.0, 22.0 ],
													"text" : "combine /mnt/c l @triggers 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 446.0, 311.0, 76.0, 22.0 ],
													"text" : "sprintf \\\"%s\\\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 432.0, 258.0, 175.0, 22.0 ],
													"text" : "gate 2"
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 243.5, 252.240600500000028, 441.5, 252.240600500000028 ],
													"order" : 0,
													"source" : [ "obj-20", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-11", 1 ],
													"midpoints" : [ 68.0, 204.981201000000056, 597.5, 204.981201000000056 ],
													"order" : 1,
													"source" : [ "obj-63", 1 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 68.0, 215.981201000000056, 382.5, 215.981201000000056 ],
													"order" : 2,
													"source" : [ "obj-63", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-8", 1 ],
													"midpoints" : [ 68.0, 162.721801500000083, 687.5, 162.721801500000083 ],
													"order" : 0,
													"source" : [ "obj-63", 1 ]
												}
...
,
									"patching_rect" : [ 17.5, 419.0, 259.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"text" : "p make_path_once-create-user-folder"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "bang" ],
									"patching_rect" : [ 17.5, 100.0, 100.0, 22.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 17.5, 60.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 246.0, 71.0, 22.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 346.0, 189.0, 41.0, 22.0 ],
									"text" : "unjoin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 346.0, 220.0, 40.0, 22.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 346.0, 156.0, 40.0, 22.0 ],
									"text" : "atoi"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 304.0, 50.0, 22.0 ],
									"text" : "Max 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 274.0, 79.0, 22.0 ],
									"text" : "prepend Max"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 128.0, 61.0, 22.0 ],
									"text" : "sprintf %x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 100.0, 95.0, 22.0 ],
									"text" : "r #0_maxver"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.0, 312.0, 50.0, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 141.0, 273.0, 57.0, 22.0 ],
									"text" : "r OSgate"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 241.0, 131.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 214.0, 33.0, 22.0 ],
									"text" : "r OS"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 139.0, 110.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 168.0, 139.0, 153.0, 35.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-91", 0 ],
									"midpoints" : [ 116.5, 300.490600500000028, 60.5, 300.490600500000028 ],
									"source" : [ "obj-88", 0 ]
								}
...
, 			{
				"box" : 				{
					"fontface" : 0,
					"fontname" : "Andale Mono",
					"fontsize" : 19.582137025938085,
					"id" : "obj-93",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 11.0, 180.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 3.0, 180.0, 29.0 ],
					"text" : "User-libraries"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 10.0, 160.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 3.0, 160.0, 42.0 ],
					"text" : "PWforMax"
				}
...
, 			{
				"name" : "make_path_once-core_date_variant.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/MOZLib/patchers/pw4m_lisp",
				"patcherrelativepath" : "../../patchers/pw4m_lisp",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "make_path_once-create-user-folder.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/MOZLib/patchers/pw4m_lisp",
				"patcherrelativepath" : "../../patchers/pw4m_lisp",
				"type" : "JSON",
				"implicit" : 1
