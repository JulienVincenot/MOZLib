...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.0, 488.0, 173.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 98.0, 510.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 2.0, -6.0, 658.0, 458.0 ],
					"presentation" : 1,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "lisp.lore.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/MOZLib/patchers/lisp_modules",
				"patcherrelativepath" : "../../patchers/lisp_modules",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
